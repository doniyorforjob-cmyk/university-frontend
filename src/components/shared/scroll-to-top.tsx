  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-[90px] right-5 z-50 w-[60px] h-[60px] flex items-center justify-center bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-full shadow-2xl hover:from-blue-600 hover:to-blue-800 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-blue-500/50 transition-all duration-300 ease-in-out group"
