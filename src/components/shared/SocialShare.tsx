...
const SocialShare: React.FC<SocialShareProps> = ({
    ...
    return (
        <div className={`flex items-center gap-3 ${className}`}>
            <span className="text-base text-black font-semibold flex items-center gap-2 mr-2">
                <Share2 size={20} className="text-blue-600" strokeWidth={2.5} />
                {t('share', 'Ulashish')}:
            </span>
            ...
            {options.facebook && (
                <button
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-all duration-300 shadow-sm"
            ...
            {options.twitter && (
                <button
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-sky-500 text-white rounded-full hover:bg-sky-600 transition-all duration-300 shadow-sm"
            ...
            {options.instagram && (
                <button
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-pink-600 text-white rounded-full hover:bg-pink-700 transition-all duration-300 shadow-sm"
