                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6">
                    <div className="flex items-center mb-6">
                      <div className="h-12 w-12 bg-white/20 rounded-lg mr-4 animate-pulse"></div>
                      <div className="space-y-2">
                        ...
                        <div key={i} className="border border-gray-200 rounded-lg p-6">
                          ...
                          <div className="space-y-2">
                            {Array.from({ length: 3 }).map((_, j) => (
                              <div key={j} className="h-4 bg-gray-300 rounded w-full animate-pulse"></div>
                            ))}
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="space-y-6">
                      {Array.from({ length: 6 }).map((_, i) => (
                        <div key={i} className="flex items-center space-x-4">
                          <div className="flex-shrink-0 w-16 h-16 bg-gray-300 rounded-full animate-pulse"></div>
