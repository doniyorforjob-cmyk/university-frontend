        ...
        <div className="bg-primary border-b border-secondary/50 header-top flex items-center">
            <Container className="flex flex-row items-center justify-between gap-2 px-2 sm:px-4 w-full py-3 md:py-0">
                ...
                <div className="flex-1 flex items-center justify-start">
                    ...
                    {settings?.oldSiteVersion && (
                        <>
                            <div className="w-px h-5 md:h-6 bg-secondary/50 mx-3 md:mx-4"></div>
                            <a
                                href={settings.oldSiteVersion}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-white hover:text-secondary transition-colors inline-flex items-center gap-1.5 md:gap-2 group"
                                title={t('oldSiteVersion') as string}
                            >
                                <FaLink className="h-3.5 w-3.5 md:h-4 md:w-4 group-hover:rotate-12 transition-transform" />
                                <span className="hidden sm:inline text-[13px] md:text-[14px] xl:text-[15px] font-medium whitespace-nowrap">
                                    {t('oldSiteVersion')}
                                </span>
                            </a>
                        </>
                ...
                <div className="hidden md:flex items-center justify-center flex-shrink-0 mx-1">
