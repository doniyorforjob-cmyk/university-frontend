...
export const navItems: NavItem[] = [
  {
    ...
    description: "Universitet yangiliklari, e'lonlar, press-relizlar va ommaviy axborot vositalari bilan hamkorlikni ta'minlovchi bo'lim. Bu yerda universitetdagi barcha voqealar haqida batafsil ma'lumot topishingiz mumkin.",
    children: [
  ...
  {
    title: 'Universitet',
    description: "Universitetning to'liq tarixi, rahbariyat tarkibi, strategik maqsad va vazifalari, shuningdek, rivojlanish rejalari haqida batafsil ma'lumot. Universitetning missiyasi va vizyoni shu yerda.",
    children: [
  ...
  },
  {
    ...
    description: "Universitetning to'liq tashkiliy tuzilmasi: rahbariyat, fakultetlar, kafedralar, bo'limlar va markazlar. Har bir bo'limning vazifalari va mas'ul shaxslar haqida batafsil.",
    children: [
      ...
      },
      {
        ...
        href: '/departments',
        children: [
          { title: 'Matematika kafedrasi', href: '/kafedralar/matematika' },
          { title: 'Dasturlash kafedrasi', href: '/kafedralar/programmalash' },
        ]
      },
      {
        title: "Bo'limlar",
        href: '/sections',
        children: [
          { title: "Marketing bo'limi", href: '/tuzilma/bolimlar/marketing' },
          { title: "Raqamli texnologiyalarni rivojlantirish", href: '/tuzilma/bolimlar/raqamli-texnologiyalar' },
        ]
      },
      {
        title: 'Markazlar',
  ...
  },
  {
    title: 'Faoliyat',
    href: '/activities',
    description: "Ilmiy loyihalar, konferensiyalar, ilmiy nashrlar va innovatsiyalar haqida batafsil ma'lumot. Ilmiy markazlar va laboratoriyalar.",
    children: [
  ...
  },
  {
    title: 'Qabul-2025',
    href: '/admission',
    description: "Talabalar hayoti, qabul jarayoni, stipendiya dasturlari, yotoqxona va talaba tashkilotlari haqida batafsil ma'lumot. Talabalar uchun qo'llanmalar va resurslar.",
    children: [
