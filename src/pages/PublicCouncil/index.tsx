...
import { getPublicCouncilData } from '../../api/http/publicCouncil.http';
...
const PublicCouncil: React.FC = () => {
    ...
    useEffect(() => {
        ...
        setBreadcrumbsData([
            ...
            { label: data?.title || t('pages:public_council', 'Jamoatchilik kengashi') }
        ]);
        return () => {
    ...
    return (
        <DetailTemplate
            title={data.title || t('pages:public_council', 'Jamoatchilik kengashi')}
            contentType="info"
