...
export const useSectionData = (
  ...
  const fetchSectionData = useCallback(async (type: HomeSectionType, id?: string): Promise<any> => {
    switch (type) {
      case 'hero':
  ...
  }, [enabled, cacheKey, sectionType, sectionId, ttl, fetchSectionData]);
  ...
  }, [cacheKey, loadData, refetchOnMount]);
