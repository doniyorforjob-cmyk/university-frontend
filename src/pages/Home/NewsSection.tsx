...
import Container from '../../components/Container'; // 1. Yangi Container komponentini import qilamiz
...
const NewsSection = () => {
  ...
  return (
    <div className="py-12 bg-gray-100">
      <Container> {/* 2. Eski div o'rniga Container komponentini ishlatamiz */}
            ...
            {currentData.map(item => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="text-fluid-h3 font-bold mb-4">{item.title}</h3>
      ...
      </Container> {/* 3. Container komponentini yopamiz */}
    </div>
  );
};
